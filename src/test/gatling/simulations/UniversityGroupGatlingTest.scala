...
/**
 * Performance test for the UniversityGroup entity.
 */
class UniversityGroupGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the UniversityGroup entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all universityGroups")
            .get("/api/university-groups")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created universityGroup")
                .get("${new_universityGroup_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created universityGroup")
            .delete("${new_universityGroup_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
